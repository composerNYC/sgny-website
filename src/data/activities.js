...
export const sessions = [
  ...
  },
  {
    ...
    material: 'Reading and discussion of a Book on Spiritism.',
  ...
  {
    slug: 'sunday-study-group-1', day: 'Sunday', time: '11:00 AM – 12:30 PM',
    name: 'Study Group: Action and Reaction', mode: 'online', tags: ['1st Sunday only'],
    audience: 'Open to the public',
    material: '“Action and Reaction,” from the spirit André Luiz through the mediumship of Francisco C. Xavier.',
    format: 'Reading and discussion of Spiritism, held online.',
    notes: ['Held on the first Sunday of each month.'],
  },
  {
    slug: 'sunday-study-group-2', day: 'Sunday', time: '11:00 AM – 12:30 PM',
    name: 'Study Group: The Gospel According to Spiritism', mode: 'online', tags: ['2nd Sunday only'],
    audience: 'Open to the public',
    material: '“The Gospel According to Spiritism” by Allan Kardec.',
    format: 'Reading and discussion of Spiritism, held online.',
    notes: ['Held on the second Sunday of each month.'],
  },
  {
    slug: 'sunday-study-group-3', day: 'Sunday', time: '11:00 AM – 12:30 PM',
    name: 'Study Group: The Mediums’ Book', mode: 'online', tags: ['3rd Sunday only'],
    audience: 'Open to the public',
    material: '“The Mediums’ Book” by Allan Kardec.',
    format: 'Reading and discussion of Spiritism, held online.',
    notes: ['Held on the third Sunday of each month.'],
  },
  {
